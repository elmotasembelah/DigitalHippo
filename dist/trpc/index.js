...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        cursor: zod_1.z.number().nullish(), // using cursor keyword allows us to use useInfiniteQuery in trpc/tanstack query
        query: query_validator_1.QueryValidator,
    }))
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, limit, sort, queryOptions, parsedQueryOptions, page, payload, _b, products, hasNextPage, nextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { products: products, nextPage: hasNextPage ? nextPage : null }];
                }
            });
        });
    }),
    greet: trpc_1.publicProcedure
        .input(function (val) {
        ...
        .query(function (_a) {
        var input = _a.input;
        return { greeding: "hello ".concat(input) };
    }),
});
