...
// Responsable for connecting to the payload client which will enable us to connect to the db (like connecting to a db e.g. mongodb)
...
var transporter = nodemailer_1.default.createTransport({
    ...
    secure: true,
    port: 465, // the default port for email
    auth: {
        user: "resend",
                ...
                case 0:
                    ...
                    if (!cached.promise) {
                        cached.promise = payload_1.default.init(__assign({ email: {
                                ...
                                fromAddress: "onboarding@resend.dev", // this is a testing domain email coming from resend (only sends to the email we logged in with at resend)
