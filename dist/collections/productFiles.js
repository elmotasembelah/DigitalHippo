...
var youOwnAndPurchesed = function (_a) {
    var req = _a.req;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductFilesIds = products.map(function (product) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFilesIds, true), purchasedProductFilesIds, true), // we mix the two arrays so it has all the ids we want to check
                            },
                        }];
            }
        });
